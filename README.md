...
- Base preservada para noticias, ferramentas, ebooks e newsletter como suporte operacional.
...
## Rotas e modulos preservados

- `/ebook/:slug`: suporte tecnico ainda existe, mas depende de posts/PDFs cadastrados.
- `src/pages/BlogPage.jsx` e `src/pages/BlogPostPage.jsx`: arquivos preservados, sem rota publica ativa em `src/App.jsx`.
- `src/data/recursos.js`: catalogo estatico usado como fallback/admin, nao como promessa publica principal.
- `api/newsletter-digest.js`, `api/news.js`, `api/out.js` e agentes: suporte operacional/editorial, nao eixo central da home.
...
- **Marked + gray-matter**: suporte legado para posts em Markdown quando a pasta de posts estiver ativa.
